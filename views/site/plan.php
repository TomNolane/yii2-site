...
$this->title = 'Мероприятия и анонсы - "НАЦИОНАЛЬНОЕ ОБЩЕСТВО КАЧЕСТВА"';
?>
...
<!-- Header -->
	<header id="head8">
		<div class="container">
			<div class="row">
				<h1 class="lead">Мероприятия и анонсы</h1>
...
<div class="container">
		...
		<div class="row">
			...
			<article class="col-md-8 maincontent">
				...
				<h1 class="page-title" id="more">Актуальные</h1>
				</header> 
				<?php 
                $i = 0;
				foreach ($models as $model) {
					...
					echo "<p>".$model['text']."</p><br>";
					if($model['source']) { echo "<p>". Html::tag('a','Источник',['href' => $model['source'], 'target' => '_blank']) ."</p>";}
                    echo '<hr>';
                    ++$i;
					if($i < 5 && $i < count($models))
					{
						echo '<center>';
						echo Html::tag('a','Следуящая новость',['class' => 'btn btn-action btn-lg', 'role'=> 'button', 'href'=>'#next'.$i.'']);
						echo '</center><hr>'; 
					} 
				}
